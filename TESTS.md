...
- 54 expect-driven end-to-end interactive scenarios.
...
| Picker UX | `history_picker_cancel_preserves_draft`, `file_picker_cancel_preserves_draft`, `template_picker_cancel_preserves_draft` | Partial | Add git branch and environment variable picker cancellation scenarios with fake `fzf` where portable. |
