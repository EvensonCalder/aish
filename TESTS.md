...
- 52 expect-driven end-to-end interactive scenarios.
...
| Picker UX | `history_picker_cancel_preserves_draft` | Partial | Add file, template, git branch, and environment variable picker cancellation scenarios with fake `fzf` where portable. |
