...
- 96 expect-driven end-to-end interactive scenarios.
...
| Notes, context, and logs | `notes_are_swallowed`, `home_default_notes_are_swallowed`, `context_config_persists`, `context_confirmation_skip`, `context_dangerous_refusal`, `home_default_context_dangerous_refusal`, `log_shows_context_skip`, `home_default_event_log_persists` | Covered | Add new context scenarios only for observed regressions. |
