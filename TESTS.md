...
- 95 expect-driven end-to-end interactive scenarios.
...
| Completion UI | `completion_accept_single`, `completion_panel_multiple`, `completion_config_persists`, `home_default_completion_ui`, `output_then_redraw_interactions` | Covered | Add completion-panel-after-output regression if observed. |
