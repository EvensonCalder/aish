...
- 47 expect-driven end-to-end interactive scenarios.
...
| Private command UX and diagnostics | `first_run_doctor`, `help_lists_commands`, `unknown_private_command`, `private_command_safe_failures`, `status_doctor_config`, `key_and_sync_placeholders`, `key_clear_removes_stored_key`, `ai_config_persists` | Covered | Add new safe-failure scenarios when new private commands are added. |
