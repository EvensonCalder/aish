...
- 55 expect-driven end-to-end interactive scenarios.
...
| Picker UX | `history_picker_cancel_preserves_draft`, `file_picker_cancel_preserves_draft`, `template_picker_cancel_preserves_draft`, `git_branch_picker_cancel_preserves_draft` | Partial | Add environment variable picker cancellation scenario with fake `fzf` where portable. |
