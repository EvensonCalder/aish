...
- 9 tmux screen-capture integration tests.
...
| Prompt/control keys | `ctrl_l_clear_screen`, `tmux_ctrl_l_clears_visible_screen_and_keeps_prompt_usable`, `readline_editing_keys`, `tmux_unicode_output_matches_real_terminal_screen`, `terminal_resize`, `escape_clears_draft`, `tmux_escape_clears_draft_and_shell_recovers`, `ctrl_x_unknown_chord_cancels`, `ctrl_d_exits`, `exit_command` | Covered | Add new prompt-control scenarios only for observed regressions. |
