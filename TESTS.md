...
- 42 expect-driven end-to-end interactive scenarios.
...
| Prompt/control keys | `ctrl_l_clear_screen`, `readline_editing_keys`, `long_unicode_input`, `escape_clears_draft`, `ctrl_x_unknown_chord_cancels`, `ctrl_d_exits`, `exit_command` | Covered | Add terminal resize workflow. |
